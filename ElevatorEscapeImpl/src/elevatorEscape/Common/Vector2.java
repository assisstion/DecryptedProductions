...
/**
 * A Vector2 class used for representing two floats.
...
public class Vector2{
	...
	/**
	 * Creates a vector2 with this.x = (float) x and this.y = (float) y;
	 * @param x the x value of the vector
	 * @param y the y value of the vector
	 */
	 ...
	 * @param f the float to take the power by
	 * @return this instance for chaining
	 */
	public Vector2 pow(float f){
		x = (float) Math.pow(x, f);
		y = (float) Math.pow(y, f);
		return this;
	}
